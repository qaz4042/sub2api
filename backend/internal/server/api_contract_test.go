		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyCcsImportBaseURL: "https://152.32.190.110",
			...
			wantJSON: `{
				...
				"data": {
					...
					"platform_configs": [
						{"key":"openai","label":"OpenAI","description":"Core OpenAI-compatible interface. Always enabled.","enabled":true,"core":true,"sort_order":10,"created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"},
						{"key":"anthropic","label":"Anthropic / Claude","description":"Claude-compatible interface.","enabled":false,"core":false,"sort_order":20,"created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"},
						{"key":"gemini","label":"Gemini","description":"Google Gemini interface.","enabled":false,"core":false,"sort_order":30,"created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"},
						{"key":"antigravity","label":"Antigravity","description":"Antigravity interface.","enabled":false,"core":false,"sort_order":40,"created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"}
					],
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminAccountHandler := adminhandler.NewAccountHandler(adminService, nil, nil, nil, nil, nil, nil, nil, nil, nil, userService, nil, nil, nil)
...
func (r *stubUsageLogRepo) GetUserAPIKeySpendingRanking(ctx context.Context, startTime, endTime time.Time, userID int64, limit int) (*usagestats.UserAPIKeyRankingResponse, error) {
	return &usagestats.UserAPIKeyRankingResponse{}, nil
}
