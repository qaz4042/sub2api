...
const (
	...
	AdminComplianceDocumentPathZH = "docs/public/legal/admin-compliance.zh.md"
	AdminComplianceDocumentPathEN = "docs/public/legal/admin-compliance.en.md"
	AdminComplianceDocumentURLZH  = "https://github.com/Wei-Shaw/sub2api/blob/main/docs/public/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/Wei-Shaw/sub2api/blob/main/docs/public/legal/admin-compliance.en.md"
