...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	platformConfigRepository := repository.NewPlatformConfigRepository(db)
	groupRepository := repository.NewGroupRepository(client, db)
	proxyRepository := repository.NewProxyRepository(client, db)
	settingService := service.ProvideSettingService(settingRepository, platformConfigRepository, groupRepository, proxyRepository, configConfig)
	...
	accountHandler := admin.NewAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, userService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator)
	...
	proxyHandler := admin.NewProxyHandler(adminService, userService)
	...
	platformConfigService := service.NewPlatformConfigService(platformConfigRepository, settingService)
	platformConfigHandler := admin.NewPlatformConfigHandler(platformConfigService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, platformConfigHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler, complianceHandler)
