export default {
    settings: {
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: '当账号当前原生用量窗口（OpenAI Codex/Anthropic 会话，或 Grok 请求/Token 利用率）达到该百分比时，当前网关会临时将其移出调度，直到窗口重置。填 100 表示禁用。',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'AI 开发工具与交流社区',
        apiBaseUrl: 'API 端点地址',
        ...
        contactMethods: {
          title: '客服联系方式',
          description: '支持配置多个客服入口，可分别启用、停用和调整展示顺序；旧文本联系方式会自动转换。',
          itemLabel: '联系方式 #{n}',
          type: '类型',
          typeLink: '链接',
          typeText: '文本',
          ...
          value: '展示内容',
          url: '跳转链接（可选）',
          valuePlaceholderLink: '例如：https://example.com/support',
          valuePlaceholderText: '例如：QQ群 123456789',
          urlPlaceholderText: '文本类型可留空',
          add: '添加联系方式',
          moveUp: '上移',
          moveDown: '下移',
          remove: '删除',
