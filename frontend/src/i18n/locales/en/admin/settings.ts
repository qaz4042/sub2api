export default {
    settings: {
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, the gateway temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Kaka Codex',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'AI Dev Tools & Community',
        ...
        contactMethods: {
          ...
          description: 'Configure multiple support entries with individual enable, disable, and display order controls. Legacy text is converted automatically.',
          itemLabel: 'Contact #{n}',
          type: 'Type',
          typeLink: 'Link',
          typeText: 'Text',
          ...
          valuePlaceholderLink: 'e.g., https://example.com/support',
          valuePlaceholderText: 'e.g., Support group 123456789',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'Kaka Codex',
        useTls: 'Use TLS',
