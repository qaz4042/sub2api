export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      apiTest: {
        description: 'Use these HTTP requests to verify the API key and endpoint, or as examples for application integration.',
        openaiDescription: 'Use the OpenAI-compatible API to verify the API key and endpoint, or as examples for application integration.',
        geminiDescription: 'Use the Gemini v1beta API to verify the API key and endpoint, or as examples for application integration.',
        antigravityDescription: 'Antigravity groups support both Claude and Gemini endpoints. Use these examples to verify each path.',
        listModelsHint: 'Start with the model list endpoint to verify that the key works.',
        requestHint: 'Copy and run in a terminal. For application integration, keep the Authorization Bearer auth method.',
        quickTestTitle: 'Quick test',
        quickTestDescription: 'Select a protocol and model, then send a real request with the current API key.',
        protocolLabel: 'Protocol',
        modelLabel: 'Model',
        promptLabel: 'Test prompt',
        promptPlaceholder: 'Enter the test prompt to send',
        defaultPrompt: 'Reply in one sentence: connection test succeeded.',
        ready: 'Ready to test',
        testing: 'Testing...',
        ...
        retry: 'Retry',
        clear: 'Clear',
        copyOutput: 'Copy test output',
        statusIdle: 'Idle',
        statusConnecting: 'Connecting',
        statusSuccess: 'Success',
        statusError: 'Failed',
        starting: 'Starting current API key test',
        response: 'Response',
  ...
  usage: {
    ...
    apiKeyRanking: {
      ...
      subtitle: 'Global ranking by actual spend in the selected date range',
      participants: '{count} keys ranked',
      myBestRank: 'My best rank',
      outranked: 'Ahead of {percent}% of keys',
      allMyKeys: 'All my key rankings',
      topTitle: 'Global Top 10',
      bySpend: 'Ranked by actual spend',
      rank: 'Rank',
      mine: 'Mine',
      anonymousKey: 'Anonymous Key',
      unnamedKey: 'Unnamed Key',
      notRanked: 'Not ranked yet',
      notRankedHint: 'Your global rank will appear after you generate usage in this date range.',
      noData: 'No ranking data in this date range',
      loadFailed: 'Failed to load leaderboard',
      loadFailedHint: 'Make sure the backend is updated and restarted, then try again.',
      privacyHint: 'Other users’ API key names are masked; key IDs and identities remain hidden.',
    },
    errors: {
  ...
  redeem: {
    ...
    historyWillAppear: 'Your balance and entitlement activity will appear here',
    balanceAddedPayment: 'Balance Added (Online Payment)',
  ...
  admin: {
    ...
    backup: {
      ...
      actions: {
        download: 'Download',
        restore: 'Restore',
        downloadPasswordPrompt: 'Please enter your admin password to confirm backup download',
    ...
    accounts: {
      ...
      dataExportPassword: 'Admin password',
      dataExportPasswordPlaceholder: 'Enter your current admin password',
      dataExportPasswordRequired: 'Please enter your admin password',
      ...
      refreshSubscription: 'Refresh Plan',
      refreshSubscriptionSuccess: 'Subscription information refreshed',
      refreshSubscriptionFailed: 'Failed to refresh subscription information',
    ...
    ops: {
      ...
      healthHelp: 'Current-window experience risk based on error rate, time to first token, and infrastructure health. Scores may fluctuate with low sample counts.',
      ...
      diagnosis: {
        ...
        lowSample: 'Low sample size ({count} requests)',
        lowSampleImpact: 'The health score can be amplified by one slow request; use trend context',
        lowSampleAction: 'Observe for 10-30 minutes or switch to a longer time range',
        ...
        ttftHighImpact: 'User perceived latency increased, usually related to upstream response, payload size, or account route',
        ttftHighAction: 'Check slow requests by model and account before changing routing',
        upstreamExperienceHigh: 'Upstream experience latency elevated ({percentile}: {ttft}ms)',
        upstreamExperienceHighImpact: 'This looks more like upstream slowness, not necessarily a code or host failure',
        upstreamExperienceHighAction: 'Check model, account, and payload size for slow requests; temporarily de-prioritize slow accounts if needed',
        ...
        healthCritical: 'Current-window experience risk is high ({score})',
        healthCriticalImpact: 'The cause may be error rate, upstream latency, or infrastructure; use the diagnostics above',
        healthCriticalAction: 'Confirm the primary signal first, then handle errors, upstream accounts, or infrastructure separately',
        healthLow: 'Current-window experience risk elevated ({score})',
        healthLowImpact: 'May indicate mild fluctuation; watch error rate, first-token latency, and upstream account behavior',
        healthLowAction: 'Use the trend and primary signal; avoid treating a single score as a system outage',
    ...
    settings: {
      ...
      features: {
        platformAccess: {
          title: 'API Platforms',
          description: 'Control public gateway access and homepage visibility from one setting. Disabled platforms reject gateway requests and are hidden from the homepage.',
          openai: 'OpenAI / Codex',
          openaiHint: 'The current core platform; always enabled.',
          anthropic: 'Anthropic / Claude',
          gemini: 'Google Gemini',
          antigravity: 'Antigravity',
          disabledHint: 'Off by default. Enabling activates both the interface and homepage entry.',
        },
        channelMonitor: {
          title: 'Channel Monitor',
      ...
      site: {
        ...
        contactMethods: {
          ...
          description: 'Configure one or more support entries. The user menu displays them as clickable actions.',
          itemLabel: 'Contact #{n}',
          type: 'Type',
          typeLink: 'Link',
          typeText: 'Text',
          ...
          valuePlaceholderLink: 'Support chat',
          valuePlaceholderText: 'QQ: 123456789',
          urlPlaceholderText: 'Leave empty for text-only contacts',
        },
