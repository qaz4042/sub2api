...
import zhDocument from '../../../../docs/platform/public/legal/admin-compliance.zh.md?raw'
import enDocument from '../../../../docs/platform/public/legal/admin-compliance.en.md?raw'
...
const currentDocument = computed(() => getLocale().startsWith('zh') ? zhDocument : enDocument)
const documentUrl = computed(() => {
  if (getLocale().startsWith('zh')) {
    return complianceStore.status?.document_url_zh || 'https://github.com/Wei-Shaw/sub2api/blob/main/docs/platform/public/legal/admin-compliance.zh.md'
  }
  return complianceStore.status?.document_url_en || 'https://github.com/Wei-Shaw/sub2api/blob/main/docs/platform/public/legal/admin-compliance.en.md'
})
